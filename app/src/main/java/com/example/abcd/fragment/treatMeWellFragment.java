...
import com.example.abcd.DynamicModelsActivity;
...
public class treatMeWellFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, Bundle savedInstanceState) {
        ...
        FloatingActionButton fab = view.findViewById(R.id.fab_dynamic_models);
        fab.setOnClickListener(v -> {
            Intent intent = new Intent(requireActivity(), DynamicModelsActivity.class);
